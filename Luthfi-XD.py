...
for t in range(10000):
  rr = random.randint
  rc = random.choice
  vr = random.choice(['2.3.6','4.0.4','4.2.1','4.2.2','4.3','4.4.2','4.4.4','5.0','5.0.2','5.1','5.1.1','6.0','6','6.0.1','7.0','7.0.1','7','8','8.0','8.0.1','9','10','11.1.1','12.2.2','2.0','4.0','4.3','4.4','5.0','5.2','5.1','6.0','6','7.0','7.1','7','8','8.0','8.1','9','10','11.1','12.1'])
  andro = random.choice(['CPH1609','CPH1941','CPH1909','CPH1969','CPH1825','CPH1919','CPH1613','CPH2001','CPH1853','CPH1907','CPH1923','CPH1871','CPH1955','CPH1989','CPH1912','CPH1819','CPH1951','CPH1911','CPH1979','CPH1903','CPH1931'])
  amr = f'Mozilla/5.0 (Linux; Android {vr}; {andro}) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/{str(rr(5,25))}.{str(rr(0,7))} Chrome/{str(rr(60,110))}.0.{str(rr(1000,5700))}.{str(rr(80,210))} Mobile Safari/537.36'
  ugen.append(amr)
...
def banner():
 ...
 | |_ / /_\ \ /  \/| |__ | |_/ /| | | || | | | |/ /     |  |   Author Script Luthfi XD
 |  _||  _  | |    |  __|| ___ \| | | || | | |    \     |  |   Update By Moch Luthfi XD
